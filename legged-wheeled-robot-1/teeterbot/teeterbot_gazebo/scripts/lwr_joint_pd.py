...
class lwr_bot():
	...
	def PID(self):
		...
		self.set_point_roll = 0 #np.arctan(-self.bot_velocity[0]*self.bot_angular_velocity[2]/g)
		...
		self.roll_distutbance = self.roll_distutbance + self.kp_roll*np.tan(self.bot_orientation_euler[0] - self.set_point_roll)*d
		self.delta_h = np.tan(self.set_point_roll)*d 
		# print(self.delta_h)
